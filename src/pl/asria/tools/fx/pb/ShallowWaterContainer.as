...
{
	import pl.asria.tools.utils.PBImageMapper;
	...
	public class ShallowWaterContainer extends Sprite
	{
		...
		[Embed(source="../pbk/DrawVelocityKernel.pbj", mimeType="application/octet-stream")]
		private var DrawVelocityKernel : Class;
		private var _drawVelocityShader : Shader;
		
		[Embed(source="../pbk/UpdateVelocities.pbj", mimeType="application/octet-stream")]
		private var UpdateVelocitiesKernel : Class;
		private var _updateVelocitiesShader : Shader;
		
		[Embed(source="../pbk/RelaxDivergence.pbj", mimeType="application/octet-stream")]
		private var RelaxDivergenceKernel : Class;
		private var _relaxDivergenceShader : Shader;
		
		[Embed(source="../pbk/GenerateDensityGradient.pbj", mimeType="application/octet-stream")]
