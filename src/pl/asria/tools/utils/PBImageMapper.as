package pl.asria.tools.utils
{
	...
	{
		[Embed(source="../fx/pbk/BitmapDataToByteArray.pbj", mimeType="application/octet-stream")]
		private var BitmapDataToByteArrayKernel : Class;
		
		[Embed(source="../fx/pbk/ByteArrayToBitmapData.pbj", mimeType="application/octet-stream")]
		private var ByteArrayToBitmapDataKernel : Class;
		
		// Vector(x, y)+Scalar combo
		[Embed(source="../fx/pbk/BitmapDataToByteArrayVVS.pbj", mimeType="application/octet-stream")]
		private var BitmapDataToByteArrayVVSKernel : Class;
		
		// Vector(x, y)+Scalar combo
		[Embed(source="../fx/pbk/ByteArrayToBitmapDataVVS.pbj", mimeType="application/octet-stream")]
